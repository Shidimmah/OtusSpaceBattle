...
from otus_space_battle.services.matchmaking_service.src.app import app
from otus_space_battle.services.matchmaking_service.src.models import Player, MatchRequest
